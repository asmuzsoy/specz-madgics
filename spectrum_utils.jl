...
Returns
-------
Log10-wavelengths of Lyman alpha emission shifted to given redshift, in Angstroms
"""
...
Log10-wavelengths of Lyman alpha emission shifted to given redshift, in Angstroms
"""
function adjust_spectrum_and_ivar(spectrum, ivar, z)
    adjustment = log10(1 + 2.45) - log10(1 + z)
    pixel_shift = round(Int, adjustment / delLog)
    adjusted_spectrum = ShiftedArrays.circshift(spectrum, pixel_shift)
...
# https://stackoverflow.com/questions/53463436/how-to-replace-inf-values-with-nan-in-array-in-julia-1-0
